  ...
  <div class="background">
    <div class="top">
      ...
      <button class="theme-button">
        <img v-if="theme == 'dark'" src="@/assets/images/icon-sun.svg" alt="IconSun">
        <img v-else src="@/assets/images/icon-moon.svg" alt="IconMoon">
      </button>
    </div>
    <div class="bottom">
      ...
      <div class="cards-container">
        <ExtensionCard :name="'Nigger'" :logoUrl="'@/assets/images/logo-json-wizard.svg'" :description="'Formats, validates, and prettifies JSON responses in-browser.'" :isActive="true"/>
        <ExtensionCard :name="'Nigger'" :logoUrl="'@/assets/images/logo-json-wizard.svg'" :description="'Formats, validates, and prettifies JSON responses in-browser.'" :isActive="true"/>
        <ExtensionCard :name="'Nigger'" :logoUrl="'@/assets/images/logo-json-wizard.svg'" :description="'Formats, validates, and prettifies JSON responses in-browser.'" :isActive="true"/>
        <ExtensionCard :name="'Nigger'" :logoUrl="'@/assets/images/logo-json-wizard.svg'" :description="'Formats, validates, and prettifies JSON responses in-browser.'" :isActive="true"/>
...
.background {
  width: 100%;
  background-image: linear-gradient(#000000, #163c67);
  padding-top: 20px;
  padding-bottom: 20px;
  height: 600px;
}
