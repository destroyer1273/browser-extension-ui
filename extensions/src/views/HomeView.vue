...
const whatToDisplay = ref('All');
const setFilter = (filterType) => {
    whatToDisplay.value = filterType;
    console.log(whatToDisplay.value);
}
const toggleTheme = () => {
...
const filteredExtensions = computed(() => {
    if(whatToDisplay.value === 'All') {
        return extensions.value;
    } else if (whatToDisplay.value === 'Active') {
        return extensions.value.filter(function(extension) {
            return extension.isActive === true;
        });
    } else if (whatToDisplay.value === 'Inactive') {
        return extensions.value.filter(function(extension) {
    ...
    <div class="bottom">
      <div class="bottom-header">
        ...
        <div class="toggle-buttons">
          <button @click="setFilter('All')" :class="{ active: whatToDisplay === 'All'}">All</button>
          <button @click="setFilter('Active')" :class="{ active: whatToDisplay === 'Active'}">Active</button>
          <button @click="setFilter('Inactive')" :class="{ active: whatToDisplay === 'Inactive'}">Inactive</button>
        </div>
      </div>
